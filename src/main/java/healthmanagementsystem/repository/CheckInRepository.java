...
public interface CheckInRepository extends JpaRepository<CheckIn, Long> {
    ...
    boolean existsByPatientAndStatus(Patient patient, CheckInStatus checkInStatus);

    List<CheckIn> findByPatientAndStatus(Patient patient, CheckInStatus checkInStatus);
